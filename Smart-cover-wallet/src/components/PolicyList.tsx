...
const POLICY_LABELS: Record<string, string> = {
  LIFE: "Life Cover", FUNERAL: "Funeral Cover", SAVINGS: "Savings Plan",
  RETIREMENT: "Retirement", DISABILITY: "Disability",
};
  ...
  if (policies.length === 0) {
    return (
      <div className="glass-card p-6 text-center">
        <p className="text-gray-500 text-sm">No policies linked yet. Policies will appear here once connected.</p>
      </div>
    );
  }
